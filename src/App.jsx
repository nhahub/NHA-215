  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/signin" element={<PublicRoute> <SignIn /> </PublicRoute>} />  {/* in nav bar */}
        <Route path="/signup" element={<PublicRoute> <Signup /> </PublicRoute>} /> {/* in nav bar */}
        ...
        <Route path="/powerbi" element={<ProtectedRoute> <Powerbi /> </ProtectedRoute> } /> {/* in dash */}
